<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Company.aspx.cs" Inherits="WebApplication5.Company" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Welcome To Company Section</h1>
          </div>
          <div class="col-sm-6">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="form-group">
                    <label for="exampleInputEmail1">Add Company</label>
              <asp:Textbox id="txtcom" runat="server" type="text" class="form-control" placeholder="Enter product category" AutoCompleteType="Disabled" />
            ...
            <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand" >
                            ...
                            <ItemTemplate>
                                <tbody>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("CompanyID") %>'></asp:Label></td>
                                        <td>
                                            <asp:Label ID="Label2" runat="server" Text='<%#Eval("CompanyName") %>'></asp:Label></td>
                                          

                                        <td>
                                <asp:LinkButton class="btn btn-warning" Text="Edit" ID="btnEdit"  CommandName="EDIT"  CommandArgument='<%#Eval("CompanyID") %>' ToolTip="Edit Record"  runat="server" style="color: #ffffff; background: #04AA60; Border: none;" />

                            </td>
                                      
                            <td>
                                <asp:LinkButton class="btn btn-warning" OnClientClick="return confirm('Are You Want To Delete This Record?')" Text="Delete" ID="btnDelete" CommandName="delete"  CommandArgument='<%#Eval("CompanyID") %>' ToolTip="Edit Record"  runat="server" style="color: #ffffff; background:#D9534F; Border: none;" />
                             </td>
                        </tr>
...
<!-- ./wrapper -->
    ...
    <script>$("#Company").addClass("nav-link active");</script>
</asp:Content>
