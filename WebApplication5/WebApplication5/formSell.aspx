<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="formSell.aspx.cs" Inherits="WebApplication5.formSell" %>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="card">
          ...
          <h3 class="card-title">Add Sell Record</h3>
            ...
            <!-- <button type="button" class="btn btn-tool" data-card-widget="remove" title="Remove"> -->
              <i class="fas fa-times"></i>
                  ...
                  <div class="form-group">
                    ...
                    <asp:DropDownList class="form-control" ID="DrpCustomer" runat="server"></asp:DropDownList>
                      <span style="margin-top: 5px;">Add new Customer here</span>
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                            ...
                                            <ContentTemplate>
                                                ...
                                                <asp:Panel ID="Panl1" runat="server" CssClass="Popup" align="center" Style="display: none;">
                                                    <iframe style="width: 800px; height: 600px; margin-left: 5%;" id="irm1" src="formCustomer.aspx" runat="server"></iframe>
                                                    <br />
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Product</label>
                      <asp:DropDownList class="form-control" ID="drpproduct" runat="server" AutoPostBack="True" placeholder="Enter product name" OnSelectedIndexChanged="drpproduct_SelectedIndexChanged" OnTextChanged="drpproduct_TextChanged"></asp:DropDownList>
                  <span style="margin-top: 5px;">Add new Product here</span>
                    ...
                    <div class="form-group">
                    <label for="exampleInputEmail1">Sell Date</label>
                    ...
                    <asp:Label for="exampleInputEmail1" runat="server" id="txtquantitychk" text="" style="color:red; font-weight: bold;" />
                    </div>
                      <div class="form-group">
                    <label for="exampleInputEmail1">Sell Price</label>
                    <asp:TextBox class="form-control" ID="txtsell" runat="server" TextMode="Number" placeholder="Enter sell price"></asp:TextBox>
                    </div>

                      <div class="form-group">
                    <label for="exampleInputEmail1">Avaliable Stock</label>
                    <asp:TextBox class="form-control" ID="quantitytextbox" runat="server" OnTextChanged="quantitytextbox_TextChanged" ReadOnly="true" />
                    </div>
<%--                      <asp:TextBox class="form-control" ID="TextBox1" runat="server"/>--%>
                ...
                <div class="card-footer">
                  <asp:Button runat="server" id="submitbtn" OnClientClick="stoprefreshbtnclick()" type="button" class="btn btn-primary" Text="Submit" CausesValidation="False" OnClick="submitbtn_Click1" />
...
'success'
    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Sell Record</h3>
        ...
        <div class="card-body" style="overflow: scroll; height: 500px;">
            <div class="form-group">
                   ...
                   <asp:Textbox id="txtsearchname" AutoPostBack="true" runat="server" type="text" class="form-control" placeholder="Enter name here" AutoCompleteType="Disabled" OnTextChanged="txtsearchname_TextChanged" />
                  </div>
                 ...
                 <ItemTemplate>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <asp:Label ID="Label2" runat="server" Text='<%#Eval("SellID") %>'></asp:Label></td>
                                    <td>
                                        <asp:Label ID="Label3" runat="server" Text='<%#Eval("ProductName") %>'></asp:Label></td>
                                    <td>
                                        <asp:Label ID="Label4" runat="server" Text='<%#Eval("Customer") %>'></asp:Label></td>
                                    <td>
...
<!-- ./wrapper -->
    ...
    <script>$("#sell").addClass("nav-link active");</script>
